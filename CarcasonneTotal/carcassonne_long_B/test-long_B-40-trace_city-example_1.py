...
print("This is the first example city from the Project Overview video...")
game.add(0,1, carcassonne_tile.tile09.rotate(), confirm=False)
game.add(1,1, carcassonne_tile.tile07         , confirm=False)
print()

print("Calling trace_city() from various start points:")
print(f"  t_c(0,0,N) returned: {city_sort(game.trace_city(0,0,N))}")
print(f"  t_c(0,1,S) returned: {city_sort(game.trace_city(0,1,S))}")
