...
print(f"  t_r(-1, 3,W) returned: {game.trace_road(-1, 3,W)}")
print(f"  t_r(-1, 3,E) returned: {game.trace_road(-1, 3,E)}")
print(f"  t_r( 2, 2,S) returned: {game.trace_road( 2, 2,S)}")
print(f"  t_r( 3, 2,N) returned: {game.trace_road( 3, 2,N)}")
print(f"  t_r( 1, 0,E) returned: {game.trace_road( 1, 0,E)}")
print(f"  t_r(-1, 0,N) returned: {game.trace_road(-1, 0,N)}")
print(f"  t_r(-1, 0,S) returned: {game.trace_road(-1, 0,S)}")
print(f"  t_r(-2, 0,N) returned: {game.trace_road(-2, 0,N)}")
print(f"  t_r(-2,-2,W) returned: {game.trace_road(-2,-2,W)}")
print(f"  t_r(-2,-2,S) returned: {game.trace_road(-2,-2,S)}")
