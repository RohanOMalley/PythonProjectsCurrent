...
def display_tile(tile, win, center, radius):
    ...
    for i in range(4):
        ...
        x2 = center_x + radius * math.cos(NW+rot)
        y2 = center_y - radius * math.sin(NW+rot)

        x3 = center_x + radius * math.cos(NE+rot)
        y3 = center_y - radius * math.sin(NE+rot)
        ...
        x4 = center_x + (radius/2) * math.cos(NW+rot)
        y4 = center_y - (radius/2) * math.sin(NW+rot)

        x5 = center_x + (radius/2) * math.cos(NE+rot)
        y5 = center_y - (radius/2) * math.sin(NE+rot)
